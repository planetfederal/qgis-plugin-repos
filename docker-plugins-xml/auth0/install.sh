...
scp request_methods_get-head-post ${SSH_CONFIG_NAME}:/home/user
...
LC_ALL="C" ssh -t ${SSH_CONFIG_NAME} "sudo mv /home/user/request_methods_get-head-post /etc/nginx/incl.d/"
